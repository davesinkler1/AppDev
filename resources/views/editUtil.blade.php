...
@section('content')
        ...
        <form class="text-center " action="utilUpdate{{ $util[0]->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Car Brand -->
            <h3 class="font-semibold tracking-wide text-center">Edit Utilities</h3>
            <div class="mt-4">
                <x-label for="brand" value="{{ __('Brand :') }}" />
                <select name="brand" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 
                focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value="{{ $util[0]->brand }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ $util[0]->name }}" required/>
            </div>
            ...
            <div class="mt-4">
                ...
                focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value="{{ $util[0]->type }}">
            ...
            <div class="mt-4">
                ...
                focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value="{{ $util[0]->area }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="price" class="block mt-1 w-full" type="text" name="price" value="{{ $util[0]->price }}" required />
            </div>
